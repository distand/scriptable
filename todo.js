...
function makeGreeting() {
    ...
    if (date.getHours() < 5) {
        greeting = greeting + "不睡觉在干嘛？"
    } else if (date.getHours() < 8) {
        greeting = greeting + "早上好"
    } else if (date.getHours() < 12) {
        greeting = greeting + "上午好"
    } else if (date.getHours() < 17) {
        greeting = greeting + "下午好"
    } else if (date.getHours() < 23) {
        greeting = greeting + "晚上好"
    } else {
        greeting = greeting + "夜深了，快睡吧"
    }
    return greeting
}
